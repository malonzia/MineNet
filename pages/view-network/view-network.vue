<template>
	<view>
		...
		<uni-list class="nodes">
			...
			<button type="default" @click="addnodeimg">修改图片</button>
		...
		<button @click="getdata" style="float: left; width: 50%;" >保存</button>
		<button type="default" style="float: right; width: 50%;" @click="enternet">进入关系网</button>
	</view>
</template>
...
<script>
	...
	export default {
		...
		onLoad: function(e) {
			...
			this.id = e.id;
			this.netid = e.netid;
			console.log(this.list[parseInt(this.netid)]);
